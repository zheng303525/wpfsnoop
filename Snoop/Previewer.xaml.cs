...
namespace Snoop
{
    public partial class Previewer
    {
        ...
        /// </summary>
        public static readonly DependencyProperty TargetProperty = DependencyProperty.Register("Target", typeof(object), typeof(Previewer), new FrameworkPropertyMetadata((object)null, new PropertyChangedCallback(OnTargetChanged)));
        ...
        /// </summary>
        public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register("IsActive", typeof(bool), typeof(Previewer), new FrameworkPropertyMetadata((bool)true, new PropertyChangedCallback(OnIsActiveChanged)));
        ...
        /// <summary>
        /// 处理<see cref="Target"/>或者<see cref="IsActive"/>属性发生变化时的处理函数
        /// </summary>
