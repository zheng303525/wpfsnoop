...
namespace Snoop
{
	...
	public class ValueEditor : ContentControl
    {
        ...
        public static DependencyProperty DescriptiveValueProperty = DependencyProperty.Register("DescriptiveValue", typeof(object), typeof(ValueEditor));
        ...
        public static readonly DependencyProperty PropertyInfoProperty = DependencyProperty.Register("PropertyInfo", typeof(PropertyInformation), typeof(ValueEditor), new UIPropertyMetadata(null, new PropertyChangedCallback(OnPropertyInfoChanged)));
